...
export const BUILT_IN_MODELS = [
  { id: 'f1', gender: 'Female', label: 'Asian Female (Light Skin)', url: '/models/f1.jpg' },
  { id: 'f2', gender: 'Female', label: 'Caucasian Female (Blonde)', url: '/models/f2.jpg' },
  { id: 'f3', gender: 'Female', label: 'African Female (Natural)', url: '/models/f3.jpg' },
  { id: 'f4', gender: 'Female', label: 'Latina Female', url: '/models/f4.jpg' },
  { id: 'f5', gender: 'Female', label: 'Southeast Asian Female', url: '/models/f5.jpg' },
  { id: 'f6', gender: 'Female', label: 'Middle Eastern Female', url: '/models/f6.jpg' },
  { id: 'f7', gender: 'Female', label: 'Redhead Caucasian Female', url: '/models/f7.jpg' },
  { id: 'f8', gender: 'Female', label: 'East Asian Female (Bob Cut)', url: '/models/f8.jpg' },
  { id: 'f9', gender: 'Female', label: 'Black Female (Braids)', url: '/models/f9.jpg' },
  { id: 'f10', gender: 'Female', label: 'Senior Caucasian Female', url: '/models/f10.jpg' },
  { id: 'm1', gender: 'Male', label: 'Caucasian Male (Stubble)', url: '/models/m1.jpg' },
  { id: 'm2', gender: 'Male', label: 'Asian Male (Clean Shaven)', url: '/models/m2.jpg' },
  { id: 'm3', gender: 'Male', label: 'Black Male (Fade Cut)', url: '/models/m3.jpg' },
  { id: 'm4', gender: 'Male', label: 'Latino Male', url: '/models/m4.jpg' },
  { id: 'm5', gender: 'Male', label: 'Middle Eastern Male (Beard)', url: '/models/m5.jpg' },
  { id: 'm6', gender: 'Male', label: 'South Asian Male', url: '/models/m6.jpg' },
  { id: 'm7', gender: 'Male', label: 'Caucasian Male (Long Hair)', url: '/models/m7.jpg' },
  { id: 'm8', gender: 'Male', label: 'East Asian Male (Street)', url: '/models/m8.jpg' },
  { id: 'm9', gender: 'Male', label: 'Senior Asian Male', url: '/models/m9.jpg' },
  { id: 'm10', gender: 'Male', label: 'Black Male (Dreads)', url: '/models/m10.jpg' },
];

export const BUILT_IN_BACKGROUNDS = [
  { id: 's1', category: 'Studio', label: 'Infinite Grey', url: '/backgrounds/s1.png' },
  { id: 's2', category: 'Studio', label: 'Pure White Cyclorama', url: '/backgrounds/s2.png' },
  { id: 's3', category: 'Studio', label: 'Textured Canvas (Brown)', url: '/backgrounds/s3.jpg' },
  { id: 's4', category: 'Studio', label: 'Dark Mood Concrete', url: '/backgrounds/s4.png' },
  { id: 's5', category: 'Studio', label: 'Gradient Blue', url: '/backgrounds/s5.png' },
  { id: 's6', category: 'Studio', label: 'Warm Beige Wall', url: '/backgrounds/s6.png' },
  { id: 's7', category: 'Studio', label: 'Industrial Loft Brick', url: '/backgrounds/s7.jpg' },
  { id: 's8', category: 'Studio', label: 'Abstract Light Shadow', url: '/backgrounds/s8.jpg' },
  { id: 's9', category: 'Studio', label: 'Pastel Pink Studio', url: '/backgrounds/s9.jpg' },
  { id: 's10', category: 'Studio', label: 'Black Velvet', url: '/backgrounds/s10.jpg' },
  { id: 'o1', category: 'Outdoor', label: 'NYC Street Corner', url: '/backgrounds/o1.jpg' },
  { id: 'o2', category: 'Outdoor', label: 'Parisian Cafe Exterior', url: '/backgrounds/o2.jpg' },
  { id: 'o3', category: 'Outdoor', label: 'Modern Glass Architecture', url: '/backgrounds/o3.jpg' },
  { id: 'o4', category: 'Outdoor', label: 'Concrete Skate Park', url: '/backgrounds/o4.jpg' },
  { id: 'o5', category: 'Outdoor', label: 'Rooftop at Sunset', url: '/backgrounds/o5.jpg' },
  { id: 'o6', category: 'Outdoor', label: 'Graffiti Alleyway', url: '/backgrounds/o6.jpg' },
  { id: 'o7', category: 'Outdoor', label: 'Luxury Storefront', url: '/backgrounds/o7.jpg' },
  { id: 'o8', category: 'Outdoor', label: 'Subway Station Platform', url: '/backgrounds/o8.jpg' },
  { id: 'o9', category: 'Outdoor', label: 'Old European Cobblestone', url: '/backgrounds/o9.jpg' },
  { id: 'o10', category: 'Outdoor', label: 'City Bridge Walkway', url: '/backgrounds/o10.jpg' },
  { id: 'w1', category: 'Wilderness', label: 'Desert Dunes', url: '/backgrounds/w1.jpg' },
  { id: 'w2', category: 'Wilderness', label: 'Forest Clearing', url: '/backgrounds/w2.jpg' },
  { id: 'w3', category: 'Wilderness', label: 'Rocky Beach Coast', url: '/backgrounds/w3.jpg' },
  { id: 'w4', category: 'Wilderness', label: 'Mountain Peak Snow', url: '/backgrounds/w4.jpg' },
  { id: 'w5', category: 'Wilderness', label: 'Tropical Jungle', url: '/backgrounds/w5.jpg' },
  { id: 'w6', category: 'Wilderness', label: 'Open Grass Field', url: '/backgrounds/w6.jpg' },
];
